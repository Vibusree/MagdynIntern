This is not a simple login page UI using html and css that is non functional. I have made this login page working with the sql databases at the backend. 
